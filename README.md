...
- Additional safety checks for other query patterns
- Enhanced visualization of query results
- Export conversation history feature
- Multi-language support
- Custom prompt templates per league
...
**New to the Oracle?** Try: "Who won the championship in 2020?"  
**Want to start fresh?** Click the "Clear Conversation" button in the sidebar!
